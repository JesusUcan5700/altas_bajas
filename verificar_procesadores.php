<?php
/**
 * Script para verificar estructura de tabla procesadores
 */
...
echo "=== ESTRUCTURA TABLA PROCESADORES ===\n\n";
...
try {
    ...
    $procesador = Yii::$app->db->createCommand("SELECT * FROM procesadores LIMIT 1")->queryOne();
    if ($procesador) {
        echo "✅ Registro encontrado:\n";
        foreach ($procesador as $campo => $valor) {
            echo "   - {$campo}: {$valor}\n";
        }
    } else {
        echo "❌ No hay registros en la tabla procesadores\n";
    }
